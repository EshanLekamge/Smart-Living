...
<center>
  <img src="images\about us.jpg" alt="smart home system" style="width:50%;">
</center>
</br>
</br>
</br>
...
<center>
  <div class="column">
    <div class="card" >
      <h3>WHO WE ARE</h3>
	  <hr/>
      <p> We are a Smart Home System Organization who manufactures,develops,sells smart home devices from years working with a number of Engineers.We have seperated teams for manufacturing,assembling,fixing and for the support services.</p>
	  </br>
	  </br>
	  </br>
   </div>
  ...
  <div class="column">
    <div class="card">
      <h3>OUR MISSION</h3>
	  <hr/>
      <p> Our company's mission is to offer home owners and contractors the widest selection, low cost, quality products as possible and to make life more convinient, safe and fun.</p>
	  </br>
	  </br>
	  </br>
	  </br>
  ...
  <div class="column">
    <div class="card">
      <h3>WHAT WE DO</h3>
	  <hr/>
      <p>We offer over 10 000 products including lightening system, security system, home automation controllers, home appliences etc.We are unbeateable at work.We can assuare you the best quality smart home devices with the latest technologies available.Our developing team is designed to amaze you with upcoming future products.</p>
	  </br>
    </div>
  </div>
  </div>
