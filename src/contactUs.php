...
.button1 {
  ...
  margin-right:1000px;
	...
	<h1>& Sales Team</h1>
	<h3>Need to get in touch with us? We are here</h3>
	</br>
	
	<button class="button1"><a href="contactform.php"> Contact Us</a></button>
	<br>
	<br>
	</br>
	</br>
	<h3>email-simplesmartliving@gmail</h3>
	<h3>call-+94115069829</h3>
	</body>
	</br>
	</br>
	</br>
