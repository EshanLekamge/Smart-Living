...
<html>
    ...
    <ul class = "mainmenu">
        ...
        <li class = "menu"><a href = "Manufacturing Process.html">Manufacturing Process</a></li>
        <li class = "menu"><a href = "Upcoming.html">Upcoming Future Products</a></li>
		<li class = "menu"><a href = "userprofile.php">User Profile</a></li>
    </ul>
  ...
  <button id ="but1" onclick="badData('but3')"> <a href="#">SECURITY</a>

   <button id ="but1" onclick="badData('but4')"><a href="furniture.php">FURNITURE</a>
     </div>
	</ul>
	<?php
			include_once 'config.php';

			$sql="SELECT * FROM products WHERE type='security'";
		...
		<div>
			...
			<img class ="logo" src="images/<?php echo $row["image"];?>" width="200" height="200" alt="pressure introduction Image">
				...
				<button type="button" onclick="alert('error')">buy now</button><br>
				<button type="button" onclick="alert('error')">order now</button><br>
